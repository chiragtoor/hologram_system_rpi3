defmodule HologramSystemRpi3.MixProject do
  use Mix.Project

  @app :hologram_system_rpi3
  ...
  defp bootstrap(args) do
    System.put_env("MIX_TARGET", "hologram_system_rpi3")
  ...
  defp package do
    [
      maintainers: ["Chirag Singh Toor"],
      files: package_files(),
      licenses: ["Apache 2.0"],
      links: %{"GitHub" => "https://github.com/chiragtoor/#{@app}"}
    ]
  end
